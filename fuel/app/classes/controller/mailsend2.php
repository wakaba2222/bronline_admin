 ...
 * @extends  Controller
 */
class Controller_MailSend2 extends ControllerPage
{
	/**
...
$body = "お客様の仮会員登録の受付けが完了致しました。".PHP_EOL."下記のURLのリンクから本会員手続きにお進みください。";

$retSend = mb_send_mail('hwakaba2222@gmail.com', $subject, $body, $header);
$retSend = mb_send_mail('nianyan2222@i.softbank.jp', $subject, $body, $header);
...
//		$headers['Content-Type']	= 'text/plain; charset=UTF-8';
		...
		//$subject = base64_encode(mb_convert_encoding($subject, "iso-2022-JP", "UTF-8"));
		...
		mb_send_mail('hwakaba2222@gmail.com', $subject, "MB:".$message, $strHeader );
//		mail('kaihatsu.test2016@gmail.com', $subject, $message, $strHeader );

//		$retSend = mb_send_mail('nianyan2222@i.softbank.jp', $subject, "MB:".$message, $strHeader );
