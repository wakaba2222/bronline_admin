...
<div class="wrap_contents sub">
	<div class="intro">
    <h3 class="contact_info_tit">会員情報変更の確認</h3>
    <p>下記の内容で送信してもよろしいでしょうか？<br>
      よろしければ、ページ下の「会員情報を変更する」ボタンをクリックしてください。</p>
	</div>
	<form name="form1" method="post" action="memberconfirm" >
...
-->
		...
		<button type="submit" name="btnSubmit" value="regist" class="submit_sys block confirm">会員情報を変更する</button>
