...
[商品]
<!--{%$registData.arrProduct[cnt].product_name|nl2br%}--> (<!--{%$registData.arrProduct[cnt].product_code%}-->)
size : <!--{%$registData.arrProduct[cnt].size_name%}-->
color : <!--{%$registData.arrProduct[cnt].color_name%}-->
