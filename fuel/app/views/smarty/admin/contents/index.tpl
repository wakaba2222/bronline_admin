...
<!--{*
                ...
                <!--{/if}-->
*}-->
				<a href="<!--{$smarty.const.HTTP_URL}-->news_entry/?entry=<!--{$arrNews[data].news_id}-->&admin=on" target="_blank"><!--{$arrNews[data].news_title|h|nl2br}--></a>
            </td>
            <td>
