...
<div id="system" class="contents-main">
    ...
    <table class="list">
        ...
        <col width="20%" />
        <div class="btn">
            <a class="btn-action" href="javascript:;" onclick="win02('./input.php','input','680','850'); return false;"><span class="btn-next">メンバーを新規入力</span></a>
        </div>
        <tr>
            <th>権限</th>
            <th>名前</th>
        ...
        <tr>
            ...
            <td align="center"><a href="#" onClick="win02('./input.php?id=<!--{$list_data[data].member_id}-->&amp;pageno=<!--{$tpl_disppage}-->','member_edit','680','850'); return false;">編集</a></td>
