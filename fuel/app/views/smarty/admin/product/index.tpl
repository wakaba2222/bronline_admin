...
*%}-->
                <!--{%assign var=keys value="search_category_id"%}-->
				...
				<optgroup label="<!--{%$parent.name%}-->">
	                ...
	                <option value="<!--{%$key%}-->" <!--{%if $key == $arrForm[$keys].value%}-->selected<!--{%/if%}-->><!--{%$category%}--></option>
	                <!--{%/foreach%}-->
	                <!--{%/foreach%}-->
				</optgroup>
				<!--{%/if%}-->
...
*%}-->
    ...
    <p style="color:red;">※セール区分、完全受注生産/予約商品の2項目はAND条件での検索になります。</p>
    <div class="btn">
...
*}-->
                    ...
                    <td class="id" rowspan="1"><!--{%if $arrProducts[cnt].sale_status == 0%}-->通常商品<!--{%elseif $arrProducts[cnt].sale_status == 1%}-->セール商品<!--{%/if%}--></td>
<!--
...
-->
                    ...
                    <td rowspan="1"><!--{%if array_key_exists('reservation_flg', $arrProducts[cnt])%}--><!--{%if $arrProducts[cnt].reservation_flg == 1%}-->完全受注生産商品<!--{%elseif $arrProducts[cnt].reservation_flg == 2%}-->予約商品<!--{%else%}--><!--{%/if%}--><!--{%/if%}--></td>
