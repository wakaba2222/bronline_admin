<div class="wrap_contents bread">
	<ul>
		...
		<li class="arrow">＞</li>
		<li><a href="/mall/<!--{%$shop_url%}-->/stylesnap/">STYLE SNAP</a></li>
		<li class="arrow">＞</li>
...
<div class="wrap_item_detail clearfix">
	<section class="fr name_area">
		...
		<a href="/mall/<!--{%$shop_url%}-->/stylesnap/" class="author inline_b"><!--{%$user['shop_name']%}--><!--{%if $post['last_name']%}--> / <!--{%$post['last_name']%}--> <!--{%$post['first_name']%}--><!--{%/if%}--></a>
