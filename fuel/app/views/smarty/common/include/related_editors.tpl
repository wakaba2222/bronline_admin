...
<section class="sec_slide justin related">
	<div class="wrap_contents">
		<div class="head_01 tit_jp clearfix">
			<h2 class="">関連記事</h2>
			<a href="/editorschoice/" class="fr btn_jp">EDITORS' CHOICE TOP</a>
		</div>
		<div class="slide_justin related">
			...
			<!--{%if 1 < $arrRelated['maxPageNum']%}-->
				...
				<!--{%/if%}-->
				<a id="btn_more2" href="<!--{%$mallurl%}-->/editorschoice/?entry=<!--{%$entry%}-->&page2=<!--{%$next_page2%}-->" class="btn_more times sp_portrait_only">LOAD MORE<i class="icon-arrow_down"></i></a>
